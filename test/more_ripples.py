...
source1 = ikonal.wave_2(f, v=3, source=(2.5, 0), falloff=0.5, starttime=1)
source2 = ikonal.wave_2(f, v=3, source=(2, 0), falloff=0.5, starttime=1.5)
source3 = ikonal.wave_2(f, v=3, source=(1, 0), falloff=0.5, starttime=2)
source4 = ikonal.wave_2(f, v=3, source=(0, 0), falloff=0.5, starttime=2.5)
source5 = ikonal.wave_2(f, v=3, source=(-1, 0), falloff=0.5, starttime=3)
source6 = ikonal.wave_2(f, v=3, source=(-1.5, 0), falloff=0.5, starttime=3.5)
source7 = ikonal.wave_2(f, v=3, source=(-1.5, 0), falloff=0.5, starttime=4)
source8 = ikonal.wave_2(f, v=3, source=(-1.5, 0), falloff=0.5, starttime=4.5)
source9 = ikonal.wave_2(f, v=3, source=(-1.5, 0), falloff=0.5, starttime=5)
