...
for i in range(num_sources):
    ...
    phase = 0
    line_of_sources.append(hl.PointSource(source=(-slit_width/2 + i * 2 * interval, 0), phase_offset=phase))
...
intensities = hl.eval_surface_intensity(sources=[*line_of_sources],
                                        surface=surface,
                                        a_range=a_range,
                                        b_range=b_range,
                                        a_density=2000,
